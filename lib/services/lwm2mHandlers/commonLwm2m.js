...
var iotAgentLib = require('iotagent-node-lib'),
    ...
    context = {
        op: 'IOTAgent.LWM2MHandlers.CoomonLwm2m'
    };
...
function observeActiveAttributes(payload, registeredDevice, callback) {
    ...
    } else if (commons.getConfig().iota.types[registeredDevice.type]) {
        activeAttributes = commons.getConfig().iota.types[registeredDevice.type].active;
    }
